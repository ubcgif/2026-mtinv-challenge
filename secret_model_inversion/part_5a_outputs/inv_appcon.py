...
dobs = np.load('../part_2_outputs/dobs_appcon.npy')
unc = np.load('../part_2_outputs/unc_appcon.npy')
...
dobs = dobs.reshape((n_freq, n_locations))
unc = unc.reshape((n_freq, n_locations))
...
# 25.10002, 50.09995, 100, 199.5001, 398.1003, 794.3001
inds = [0, 3, 6, 9, 12, 15]
...
for f in frequencies:
    ...
    source_list = [nsem.sources.FictitiousSource(receiver_list, f)]
